  ...
  return (
    <Container>
      <div>
        ...
        <Button className="button" bg="bg.primary" color="content.primary" href="https://paypal.me/awibawa/5" target="_blank" rel="noopener">
          <icons.Coin size={16} style={{ marginRight: 8 }} />
          <span name="Donate">Donate</span>
          <icons.ArrowUpRight size={16} style={{ marginLeft: 8 }} />
        </Button>
      </div>
      <div
