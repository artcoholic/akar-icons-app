...
const Header = ({ icons, setHeight, theme, themeToggler }) => {
  ...
  return (
    <Container id="myHeader" ref={ref}>
      <Wrapper justifyContent="center" padding="12px 0">
        <HeaderTitle>Akar Icons</HeaderTitle>
      </Wrapper>
      <InnerContainer>
        <Wrapper alignItems="center" mb="2em" flexDirection="column">
          <Logo>
            <svg
              viewBox="0 0 800 800"
              fill="none"
          ...
          <SubTitle>
            Use these icons to bring life into your user interface and
            experience. Free to use for your personal and commercial projects.
            Start creating!
          </SubTitle>
        </Wrapper>
        ...
        <Wrapper justifyContent="center">
          <ButtonLink
            ...
            rel="noopener"
          >
            <icons.Paper size={16} style={{ marginRight: 8 }} /> Read the docs{" "}
          ...
          <ButtonLink
            ...
            bg="primary"
            color="primary"
            href="https://paypal.me/awibawa/5"
            target="_blank"
            rel="noopener"
          >
            <icons.Coin size={16} style={{ marginRight: 8 }} /> Donate{" "}
            <icons.ArrowUpRight size={16} style={{ marginLeft: 8 }} />
          </ButtonLink>
        </Wrapper>
      </InnerContainer>
